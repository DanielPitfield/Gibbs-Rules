...
export const PersonMappings: PersonMapping[] = [
  ...
  { person: "Ducky", images: Object.values(DuckyImages), array: [], isPermanentDailyCharacter: false },
...
// These characters each have an equal chance of appearing as the third character
