...
export const gibbsRules: GibbsRuleTemplate[] = [
  ...
  { number: 40, rule: "If it seems like someone's out to get you, they are.", flair: "emergency" },
  { number: 42, rule: "Never accept an apology from somebody who just sucker punched you.", flair: "emergency" },
  { number: 44, rule: "First things first, hide the women and children.", flair: "emergency" },
  { number: 45, rule: "Always clean up your mess.", flair: "emergency" },
  { number: 51, rule: "Sometimes you're wrong.", flair: "golden" },
