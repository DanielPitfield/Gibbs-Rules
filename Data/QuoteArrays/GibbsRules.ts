...
export const gibbsRules: ConversationTemplate[] = [
  ...
  [{ person: "Gibbs", title: "Rule #5", message: "You don't waste good.", flair: "golden" }],
  [
    {
      person: "Gibbs",
      title: "Rule #6",
  ...
  [{ person: "Gibbs", title: "Rule #9", message: "Never go anywhere without a knife.", flair: "golden" }],
  [{ person: "Gibbs", title: "Rule #10", message: "Never get personally involved on a case.", flair: "iconic" }],
  ...
  [{ person: "Gibbs", title: "Rule #38", message: "Your case, you're lead.", flair: "iconic" }],
  [{ person: "Gibbs", title: "Rule #39", message: "There is no such thing as coincidence.", flair: "iconic" }],
  [
    {
      person: "Gibbs",
      title: "Rule #40",
