...
export const gibbsRules: ConversationTemplate[] = [
  ...
  [{ person: "Gibbs", title: "Rule #6", message: "Never say you're sorry - it's a sign of weakness." }],
  ...
  [{ person: "Gibbs", title: "Rule #12", message: "Never date a coworker." }],
  ...
  [{ person: "Gibbs", title: "Rule #39", message: "There is no such thing as coincidence." }],
  [
    {
      person: "Gibbs",
      title: "Rule #40",
